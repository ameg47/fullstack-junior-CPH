...
export default function Nav (){
    ...
    return(
        <nav className="py-4 px-4">
            <div className=" w-full lg:px-4 flex flex-wrap lg:flex-nowrap items-center">
                <div className="w-48 lg:mr-48 relative flex lg:justify-start ">
                    ...
                    <p className="text-blue-400 font-semibold text-center flex self-center">HEALTH EXPLORE</p>
                </div>
                <div className={`lg:flex w-full justify-between ${navbarOpen ? 'mt-2 flex justify-center flex-col lg:flex-row list-none ' : 'hidden'}`}>
                    ...
                    <button className="border-blue-500 text-sm font-bold text-blue-500 hover:bg-blue-500 hover:text-white border border-myred py-2 xl:px-4 rounded-lg hidden lg:block">CREATE JOB</button>
                    <button className="text-sm mt-2 lg:text-base font-medium text-center self-center lg:hidden">CREATE JOB</button>
                    <button className="text-sm lg:text-base font-medium text-center self-center lg:ml-2">LOGOUT</button>
